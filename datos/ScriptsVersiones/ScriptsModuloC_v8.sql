...
BEGIN
    ...
    WHILE v_i < v_n DO
        ...
        SELECT cantidad_solicitada INTO v_cant_solicitada
...
-- [FIX-12] Auditoría RNF04.
-- [RNF03]  La validación de que p_usuario_autorizador tenga rol
--          Administrador se realiza en la capa de aplicación.
--          Este procedimiento solo registra el usuario autorizador recibido.
-- ------------------------------------------------------------
...
BEGIN
    ...
    -- [CU-05] Validar que el monto no supere lo pendiente de facturación de la OC
    IF p_factura_excepcional = 0 THEN
        BEGIN
