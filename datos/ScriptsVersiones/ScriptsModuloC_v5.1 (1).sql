...
--    Recepcion y DetalleRecepcion (B.4: "eliminar padre implica
...
-- NOT DETERMINISTIC: lee de la tabla Proveedor.
-- ------------------------------------------------------------
...
-- Borrado lógico en cascada: OC → detalle_oc → Recepcion
-- → DetalleRecepcion (B.4).
-- [FIX-5] Cascada extendida a Recepcion y DetalleRecepcion;
...
BEGIN
    ...
    -- 1. DetalleRecepcion vinculado a esta OC
    ...
    -- 2. Recepcion vinculadas a esta OC
    UPDATE Recepcion
    SET    activo            = 0,
